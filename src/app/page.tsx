        ...
        <Container>
          <Row className="justify-content-center text-center">
            <Col xs={12}>
              ...
              <Button className="btn-dark mt-4" type="button" onClick={handleSignUpClick}>
                Sign Up
              </Button>
            </Col>
          </Row>
          ...
          <Row className="text-center">
            <Col xs={12}>
              ...
              <h5>
                ...
                , we understand the struggles of college students—limited kitchen
                resources, time constraints, and tight budgets. Our mission is to make cooking simple, affordable,
                and fun by providing recipes that can be made with minimal equipment and easily sourced ingredients.
              </h5>
              <h5>~~~</h5>
              <h5>
                We aim to help students improve their nutrition and save money by offering tasty alternatives to fast
                food. Whether you are looking to cook a quick meal in your dorm with just a rice cooker or find
                affordable local vendors who carry what you need, we got you covered.
              </h5>
            </Col>
          </Row>
        </Container>
